...
class SnefuruPlugin {
    ...
    private function create_tables() {
        ...
        $zen_sitespren_sql = "CREATE TABLE $zen_sitespren_table (
            ...
            boilerplatich_victoria_go_to_blog_button_text TEXT DEFAULT NULL,
            PRIMARY KEY (id),
        ...
        $pylons_sql = "CREATE TABLE IF NOT EXISTS $pylons_table (
            ...
            content_bay_1 TEXT DEFAULT NULL,
            content_bay_2 TEXT DEFAULT NULL,
            content_bay_1_image_id TEXT DEFAULT NULL,
            content_bay_2_image_id TEXT DEFAULT NULL,
            content_lake TEXT DEFAULT NULL,
            content_sea TEXT DEFAULT NULL,
            ...
            reviewsbox_heading TEXT DEFAULT NULL,
            reviewsbox_subheading TEXT DEFAULT NULL,
            reviewsbox_description TEXT DEFAULT NULL,
            reviewsbox_review1_stars TINYINT DEFAULT NULL,
            reviewsbox_review1_content TEXT DEFAULT NULL,
            reviewsbox_review1_location TEXT DEFAULT NULL,
            reviewsbox_review1_name TEXT DEFAULT NULL,
            reviewsbox_review1_image_id BIGINT(20) UNSIGNED DEFAULT NULL,
            reviewsbox_review1_service TEXT DEFAULT NULL,
            reviewsbox_review1_date DATETIME DEFAULT NULL,
            reviewsbox_review2_stars TINYINT DEFAULT NULL,
            reviewsbox_review2_content TEXT DEFAULT NULL,
            reviewsbox_review2_location TEXT DEFAULT NULL,
            reviewsbox_review2_name TEXT DEFAULT NULL,
            reviewsbox_review2_image_id BIGINT(20) UNSIGNED DEFAULT NULL,
            reviewsbox_review2_service TEXT DEFAULT NULL,
            reviewsbox_review2_date DATETIME DEFAULT NULL,
            reviewsbox_review3_stars TINYINT DEFAULT NULL,
            reviewsbox_review3_content TEXT DEFAULT NULL,
            reviewsbox_review3_location TEXT DEFAULT NULL,
            reviewsbox_review3_name TEXT DEFAULT NULL,
            reviewsbox_review3_image_id BIGINT(20) UNSIGNED DEFAULT NULL,
            reviewsbox_review3_service TEXT DEFAULT NULL,
            reviewsbox_review3_date DATETIME DEFAULT NULL,
            reviewsbox_review4_stars TINYINT DEFAULT NULL,
            reviewsbox_review4_content TEXT DEFAULT NULL,
            reviewsbox_review4_location TEXT DEFAULT NULL,
            reviewsbox_review4_name TEXT DEFAULT NULL,
            reviewsbox_review4_image_id BIGINT(20) UNSIGNED DEFAULT NULL,
            reviewsbox_review4_service TEXT DEFAULT NULL,
            reviewsbox_review4_date DATETIME DEFAULT NULL,
            reviewsbox_review5_stars TINYINT DEFAULT NULL,
            reviewsbox_review5_content TEXT DEFAULT NULL,
            reviewsbox_review5_location TEXT DEFAULT NULL,
            reviewsbox_review5_name TEXT DEFAULT NULL,
