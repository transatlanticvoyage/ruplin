-- Insert comprehensive test data for page ID 2196
-- This will populate all text fields across all tabs with realistic dummy content
...
-- Update all fields with test data
UPDATE wp_pylons SET 
    ...
    page_title = 'Bathroom Remodeling Lakeland FL - Professional Contractors',
    page_content = 'Welcome to Lakeland''s premier bathroom remodeling service. We specialize in complete bathroom transformations, from modern vanities to luxury shower installations.',
    end_of_all_content = 'Ready to start your bathroom transformation? Contact us today for a free consultation and estimate.',
    ...
    -- Kendall Our Process fields
    kendall_ourprocess_box_heading = 'Our Proven Bathroom Remodeling Process',
    kendall_ourprocess_box_subheading = 'From consultation to completion in 5 simple steps',
    kendall_ourprocess_box_description = 'We''ve perfected our remodeling process to ensure every project is completed on time, within budget, and to your exact specifications.',
    kendall_ourprocess_box_step1_title = 'Free In-Home Consultation',
    kendall_ourprocess_box_step1_desc = 'We visit your home to assess your space, discuss your vision, and provide expert recommendations tailored to your needs and budget.',
    kendall_ourprocess_box_step2_title = 'Design & Material Selection',
    kendall_ourprocess_box_step2_desc = 'Our design team creates detailed plans and helps you select materials, fixtures, and finishes that bring your vision to life.',
    kendall_ourprocess_box_step3_title = 'Transparent Pricing & Contracts',
    kendall_ourprocess_box_step3_desc = 'We provide detailed estimates with no hidden fees and clear timelines. Once approved, we schedule your project start date.',
    kendall_ourprocess_box_step4_title = 'Professional Installation',
    kendall_ourprocess_box_step4_desc = 'Our skilled craftsmen complete your renovation with precision and care, keeping you informed throughout the entire process.',
    kendall_ourprocess_box_step5_title = 'Final Walkthrough & Warranty',
    kendall_ourprocess_box_step5_desc = 'We conduct a thorough final inspection with you and provide comprehensive warranty documentation for your peace of mind.',
    kendall_ourprocess_box_outro = 'Ready to start your bathroom transformation? Contact us today to schedule your free consultation.',
